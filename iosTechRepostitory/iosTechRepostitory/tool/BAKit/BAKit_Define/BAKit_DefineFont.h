...
CG_INLINE UIFont *
BAKit_Font_systemFontOfSizeAndWeight(CGFloat fontSize, UIFontWeight weight){
    return [UIFont systemFontOfSize:fontSize weight:weight];
}

#pragma mark - 自定义等宽字体大小和粗细
CG_INLINE UIFont *
BAKit_Font_monospacedDigitSystemFontOfSizeAndWeight(CGFloat fontSize, UIFontWeight weight){
