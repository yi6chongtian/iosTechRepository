...
+ (NSString *)ba_stringInterceptTwoDecimalPlacesWithFloatNumberString:(NSString *)floatNumberString
{
    if ([floatNumberString ba_stringIncludesString:@"."])
    {
        ...
        NSString *resultString = [[firstString stringByAppendingString:@"."] stringByAppendingString:lastString];
        return resultString;
    }
    NSLog(@"传入的字符串：%@ 不包含小数点！", floatNumberString);
    return @"";
}
...
+ (NSString *)ba_stringInterceptNODecimalPlacesWithFloatNumberString:(NSString *)floatNumberString
{
    if ([floatNumberString ba_stringIncludesString:@"."])
    {
        ...
        NSString *resultString = firstString;
        return resultString;
    }
    NSLog(@"传入的字符串：%@ 不包含小数点！", floatNumberString);
    return @"";
...
/**
 NSString：快速创建一个 高亮 文字
 
 @param allString 所有文字
 @param changeColorString 高亮文字
 @param hilightColor 高亮颜色
 @return NSMutableAttributedString
 */
+ (NSMutableAttributedString *)ba_stringGetAttributedStringWithAllString:(NSString *)allString
                                                       changeColorString:(NSString *)changeColorString
                                                            hilightColor:(UIColor *)hilightColor
{
    ...
    NSRange range = [allString rangeOfString:changeColorString];
    [attributedString ba_changeColor:hilightColor range:range];
