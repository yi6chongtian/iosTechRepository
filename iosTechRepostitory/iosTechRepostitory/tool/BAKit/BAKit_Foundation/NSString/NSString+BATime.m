...
//    NSInteger interval = [timeZone secondsFromGMTForDate:interval];
...
/**
 ...
 @return 早上/中午/下午/晚上
 */
- (NSString *)ba_time_getTheTimeBucket
{
    NSDate *currentDate = [NSDate date];
    
    if ([currentDate compare:[self ba_time_getCustomDateWithHour:0]] == NSOrderedDescending && [currentDate compare:[self ba_time_getCustomDateWithHour:9]] == NSOrderedAscending)
    {
        return @"早上";
    }
    else if ([currentDate compare:[self ba_time_getCustomDateWithHour:9]] == NSOrderedDescending && [currentDate compare:[self ba_time_getCustomDateWithHour:11]] == NSOrderedAscending)
    {
        return @"上午";
    }
    else if ([currentDate compare:[self ba_time_getCustomDateWithHour:11]] == NSOrderedDescending && [currentDate compare:[self ba_time_getCustomDateWithHour:13]] == NSOrderedAscending)
    {
        return @"中午";
    }
    else if ([currentDate compare:[self ba_time_getCustomDateWithHour:13]] == NSOrderedDescending && [currentDate compare:[self ba_time_getCustomDateWithHour:18]] == NSOrderedAscending)
    {
        return @"下午";
    }
    else
